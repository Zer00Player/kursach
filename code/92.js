(function() {
	retryWhileError(function() {
		...
		NAtask.setTask({
			text: 'Площадь параллелограмма $' + vertices.slice(0, 4).permuteCyclic(sl(0, 3)).join('') |\label{line:permuteCyclic-1}| + '$ равна $' + a +
				'$. Точка $' + vertices[4] + '$ – середина стороны $' + vertices.slice(1, 3).shuffleJoin() +
				'$. Найдите площадь трапеции $' + trapezoid.permuteCyclic(sl(0, 3)).join('') |\label{line:permuteCyclic-2}| + '$.',
			answers: a * 0.75,
		});
